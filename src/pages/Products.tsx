...
useEffect(() => {
  trackingRef.current = setInterval(async () => {
    ...
    try {
      // 1. Send to /track endpoint (optional logging)
      ...
      // 2. Send to /ml-score endpoint for trust evaluation
      ...
      const { trustScore, actionTaken, explanation } = mlResponse.data;
      ...
      if (actionTaken === 'blocked') {
        ...
        console.warn('⚠️ Unusual behavior detected, but session continues. Trust Score:', trustScore);
        // Optional: You can show a warning banner or modal here
      }
